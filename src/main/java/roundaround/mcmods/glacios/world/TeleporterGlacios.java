...
public class TeleporterGlacios extends Teleporter {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
        ...
        if (this.destinationCoordinateCache.containsItem(j1)) {
            TeleporterGlacios.PortalPosition portalposition = (TeleporterGlacios.PortalPosition) this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        if (d3 >= 0.0D) {
            if (flag) {
                this.destinationCoordinateCache.add(j1,
                        new TeleporterGlacios.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
    ...
    public void removeStalePortalLocations(long par1) {
        if (par1 % 100L == 0L) {
            ...
            while (iterator.hasNext()) {
                ...
                TeleporterGlacios.PortalPosition portalposition = (TeleporterGlacios.PortalPosition) this.destinationCoordinateCache.getValueByKey(olong
                        .longValue());
