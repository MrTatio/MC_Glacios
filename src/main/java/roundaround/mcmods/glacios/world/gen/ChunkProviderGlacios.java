...
public class ChunkProviderGlacios implements IChunkProvider {
    ...
    public void func_147422_a(int chunkX, int chunkZ, Block[] blockArray, byte[] metaArray, BiomeGenBase[] biomeArray) {
        ...
        MapGenVolcano mapGen = new MapGenVolcano(GlaciosBlocks.ash, Blocks.lava, this.worldObj.getSeed());
        mapGen.generateInChunk(blockArray, metaArray, biomeArray, rand, chunkX, chunkZ);
    }
